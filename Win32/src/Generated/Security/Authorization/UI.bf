...
[CRepr]struct ISecurityInformation : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid pguidObjectType, SECURITY_INFO_PAGE_FLAGS dwFlags, SI_ACCESS** ppAccess, uint32 pcAccesses, uint32 piDefaultAccess) GetAccessRights;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid pguidObjectType, uint8 pAceFlags, uint32 pMask) MapGeneric;
...
[CRepr]struct IEffectivePermission : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid pguidObjectType, PSID pUserSid, PWSTR pszServerName, SECURITY_DESCRIPTOR* pSD, OBJECT_TYPE_LIST** ppObjectTypeList, uint32 pcObjectTypeListLength, uint32** ppGrantedAccessList, uint32 pcGrantedAccessListLength) GetEffectivePermission;
	}

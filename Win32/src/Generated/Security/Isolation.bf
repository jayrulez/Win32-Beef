...
public static
{
	...
	public static extern BOOL GetAppContainerNamedObjectPath(HANDLE Token, PSID AppContainerSid, uint32 ObjectPathLength, char8* ObjectPath, uint32* ReturnLength);

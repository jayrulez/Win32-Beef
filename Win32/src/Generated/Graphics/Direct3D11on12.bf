...
[CRepr]struct ID3D11On12Device : IUnknown
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pResource12, D3D11_RESOURCE_FLAGS* pFlags11, D3D12_RESOURCE_STATES InState, D3D12_RESOURCE_STATES OutState, Guid riid, void** ppResource11) CreateWrappedResource;
...
[CRepr]struct ID3D11On12Device2 : ID3D11On12Device1
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, ID3D11Resource* pResource11, ID3D12CommandQueue* pCommandQueue, Guid riid, void** ppvResource12) UnwrapUnderlyingResource;

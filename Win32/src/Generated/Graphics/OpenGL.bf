...
public static
{
	...
	[Import("OPENGL32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern uint8 glAreTexturesResident(int32 n, in uint32 textures, uint8* residences);
	...
	[Import("GLU32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern int32 gluProject(double objx, double objy, double objz, in double modelMatrix, in double projMatrix, in int32 viewport, double* winx, double* winy, double* winz);
	...
	[Import("GLU32.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern void gluLoadSamplingMatrices(GLUnurbs* nobj, in float modelMatrix, in float projMatrix, in int32 viewport);

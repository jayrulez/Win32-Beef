...
public function uint32 DOT11EXT_QUERY_VIRTUAL_STATION_PROPERTIES(HANDLE hDot11SvcHandle, BOOL* pbIsVirtualStation, ref Guid pgPrimary, void* pvReserved);
...
public struct NDIS_TIMEOUT_DPC_REQUEST_CAPABILITIES
{
	...
	public uint32* TimeoutArray mut => &TimeoutArray_impl;
	private uint32[ANYSIZE_ARRAY] TimeoutArray_impl;
}
...
public struct NDIS_802_11_PMKID_CANDIDATE_LIST
{
	...
	public PMKID_CANDIDATE* CandidateList mut => &CandidateList_impl;
	private PMKID_CANDIDATE[ANYSIZE_ARRAY] CandidateList_impl;
}
...
public struct NDIS_802_11_NETWORK_TYPE_LIST
{
	...
	public NDIS_802_11_NETWORK_TYPE* NetworkType mut => &NetworkType_impl;
	private NDIS_802_11_NETWORK_TYPE[ANYSIZE_ARRAY] NetworkType_impl;
}
...
public struct NDIS_802_11_KEY
{
	...
	public uint8* KeyMaterial mut => &KeyMaterial_impl;
	private uint8[ANYSIZE_ARRAY] KeyMaterial_impl;
}
...
{
	public uint32 NumberOfItems;
	public NDIS_WLAN_BSSID* Bssid mut => &Bssid_impl;
	private NDIS_WLAN_BSSID[ANYSIZE_ARRAY] Bssid_impl;
}
...
public struct NDIS_WLAN_BSSID_EX
{
	...
	public uint8* IEs mut => &IEs_impl;
	private uint8[ANYSIZE_ARRAY] IEs_impl;
}
...
{
	public uint32 NumberOfItems;
	public NDIS_WLAN_BSSID_EX* Bssid mut => &Bssid_impl;
	private NDIS_WLAN_BSSID_EX[ANYSIZE_ARRAY] Bssid_impl;
}
...
public struct NDIS_802_11_AUTHENTICATION_EVENT
{
	...
	public NDIS_802_11_AUTHENTICATION_REQUEST* Request mut => &Request_impl;
	private NDIS_802_11_AUTHENTICATION_REQUEST[ANYSIZE_ARRAY] Request_impl;
}
...
public struct NDIS_802_11_PMKID
{
	...
	public BSSID_INFO* BSSIDInfo mut => &BSSIDInfo_impl;
	private BSSID_INFO[ANYSIZE_ARRAY] BSSIDInfo_impl;
}
...
public struct NDIS_802_11_CAPABILITY
{
	...
	public NDIS_802_11_AUTHENTICATION_ENCRYPTION* AuthenticationEncryptionSupported mut => &AuthenticationEncryptionSupported_impl;
	private NDIS_802_11_AUTHENTICATION_ENCRYPTION[ANYSIZE_ARRAY] AuthenticationEncryptionSupported_impl;
}
...
{
	public uint32 NumberOfItems;
	public NDIS_802_11_SSID* Non_Bcast_Ssid mut => &Non_Bcast_Ssid_impl;
	private NDIS_802_11_SSID[ANYSIZE_ARRAY] Non_Bcast_Ssid_impl;
}
...
public struct OFFLOAD_IPSEC_ADD_SA
{
	...
	public uint8* KeyMat mut => &KeyMat_impl;
	private uint8[ANYSIZE_ARRAY] KeyMat_impl;
}
...
public struct NETWORK_ADDRESS_LIST
{
	...
	public uint16 AddressType;
	public NETWORK_ADDRESS* Address mut => &Address_impl;
	private NETWORK_ADDRESS[ANYSIZE_ARRAY] Address_impl;
}
...
public struct NDIS_WMI_ENUM_ADAPTER
{
	...
	public CHAR* DeviceName mut => &DeviceName_impl;
	private CHAR[ANYSIZE_ARRAY] DeviceName_impl;
}
...
public struct NDIS_PORT_ARRAY
{
	...
	public NDIS_PORT_CHARACTERISTICS* Ports mut => &Ports_impl;
	private NDIS_PORT_CHARACTERISTICS[ANYSIZE_ARRAY] Ports_impl;
}

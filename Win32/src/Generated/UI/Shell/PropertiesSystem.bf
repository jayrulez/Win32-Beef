...
[CRepr]struct IPropertyChangeArray : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 iIndex, Guid riid, void** ppv) GetAt;
...
[CRepr]struct IPropertyEnumTypeList : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 itype, Guid riid, void** ppv) GetAt;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 nIndex, Guid riid, void** ppv) GetConditionAt;
...
[CRepr]struct IPropertyDescription : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppv) GetEnumTypeList;
...
[CRepr]struct IPropertyDescriptionAliasInfo : IPropertyDescription
{
	...
	[CRepr]public struct VTable : IPropertyDescription.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppv) GetSortByAlias;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppv) GetAdditionalSortByAliases;
	}
...
[CRepr]struct IPropertyDescriptionRelatedPropertyInfo : IPropertyDescription
{
	...
	[CRepr]public struct VTable : IPropertyDescription.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PWSTR pszRelationshipName, Guid riid, void** ppv) GetRelatedProperty;
	}
...
[CRepr]struct IPropertySystem : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PROPERTYKEY* propkey, Guid riid, void** ppv) GetPropertyDescription;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PWSTR pszCanonicalName, Guid riid, void** ppv) GetPropertyDescriptionByName;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PWSTR pszPropList, Guid riid, void** ppv) GetPropertyDescriptionListFromString;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PROPDESC_ENUMFILTER filterOn, Guid riid, void** ppv) EnumeratePropertyDescriptions;
...
[CRepr]struct IPropertyDescriptionList : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 iElem, Guid riid, void** ppv) GetAt;
	}
...
[CRepr]struct IPropertyStoreFactory : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, GETPROPERTYSTOREFLAGS flags, IUnknown* pUnkFactory, Guid riid, void** ppv) GetPropertyStore;
...
[CRepr]struct IDelayedPropertyStoreFactory : IPropertyStoreFactory
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, GETPROPERTYSTOREFLAGS flags, uint32 dwStoreId, Guid riid, void** ppv) GetDelayedPropertyStore;
	}
...
[CRepr]struct ICreateObject : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid clsid, IUnknown* pUnkOuter, Guid riid, void** ppv) CreateObject;
	}
...
[CRepr]struct IPropertyUI : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid fmtid, uint32 pid, char16* pwszText, uint32 cchText) GetCannonicalName;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid fmtid, uint32 pid, PROPERTYUI_NAME_FLAGS flags, char16* pwszText, uint32 cchText) GetDisplayName;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid fmtid, uint32 pid, char16* pwszText, uint32 cchText) GetPropertyDescription;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid fmtid, uint32 pid, uint32 pcxChars) GetDefaultWidth;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid fmtid, uint32 pid, PROPERTYUI_FLAGS* pflags) COM_GetFlags;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid fmtid, uint32 pid, PROPVARIANT* ppropvar, PROPERTYUI_FORMAT_FLAGS puiff, char16* pwszText, uint32 cchText) FormatForDisplay;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid fmtid, uint32 pid, char16* pwszHelpFile, uint32 cch, uint32 puHelpID) GetHelpInfo;
	}

...
[CRepr]struct IKnownFolderManager : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, ref Guid rfid, HWND hwnd, uint32 flags, PWSTR pszTargetPath, uint32 cFolders, Guid* pExclusion, PWSTR* ppszError) Redirect;
	}
	...
	public HRESULT Redirect(ref Guid rfid, HWND hwnd, uint32 flags, PWSTR pszTargetPath, uint32 cFolders, Guid* pExclusion, PWSTR* ppszError) mut => VT.[Friend]Redirect(&this, ref rfid, hwnd, flags, pszTargetPath, cFolders, pExclusion, ppszError);
}

...
[CRepr]struct IDMLObject : IUnknown
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid guid, uint32 dataSize, void* data) GetPrivateData;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid guid, uint32 dataSize, void* data) SetPrivateData;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid guid, IUnknown* data) SetPrivateDataInterface;
...
[CRepr]struct IDMLDevice : IDMLObject
{
	...
	[CRepr]public struct VTable : IDMLObject.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, DML_OPERATOR_DESC* desc, Guid riid, void** ppv) CreateOperator;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IDMLOperator* op, DML_EXECUTION_FLAGS flags, Guid riid, void** ppv) CompileOperator;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 operatorCount, IDMLCompiledOperator** operators, Guid riid, void** ppv) CreateOperatorInitializer;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppv) CreateCommandRecorder;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, DML_BINDING_TABLE_DESC* desc, Guid riid, void** ppv) CreateBindingTable;
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppv) GetParentDevice;
	}
...
[CRepr]struct IDMLDeviceChild : IDMLObject
{
	...
	[CRepr]public struct VTable : IDMLObject.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppv) GetDevice;
	}
...
[CRepr]struct IDMLDevice1 : IDMLDevice
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, DML_GRAPH_DESC* desc, DML_EXECUTION_FLAGS flags, Guid riid, void** ppv) CompileGraph;
	}

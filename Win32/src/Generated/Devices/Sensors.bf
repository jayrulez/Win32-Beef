...
public struct SENSOR_COLLECTION_LIST
{
	...
	public uint32 Count;
	public SENSOR_VALUE_PAIR* List mut => &List_impl;
...
public struct SENSOR_PROPERTY_LIST
{
	public uint32 AllocatedSizeInBytes;
	public uint32 Count;
	public PROPERTYKEY* List mut => &List_impl;
...
#region COM Types
[CRepr]struct ISensorManager : IUnknown
{
	public new const Guid IID = .(0xbd77db67, 0x45a8, 0x42dc, 0x8d, 0x00, 0x6d, 0xcf, 0x15, 0xf8, 0x37, 0x7a);

	public new VTable* VT { get => (.)mVT; }

	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid* sensorCategory, ISensorCollection** ppSensorsFound) GetSensorsByCategory;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid* sensorType, ISensorCollection** ppSensorsFound) GetSensorsByType;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid* sensorID, ISensor** ppSensor) GetSensorByID;
	...
	public HRESULT RequestPermissions(HWND hParent, ISensorCollection* pSensors, BOOL fModal) mut => VT.[Friend]RequestPermissions(&this, hParent, pSensors, fModal);
}

[CRepr]struct ILocationPermissions : IUnknown
{
	public new const Guid IID = .(0xd5fb0a7f, 0xe74e, 0x44f5, 0x8e, 0x02, 0x48, 0x06, 0x86, 0x3a, 0x27, 0x4f);
	...
	public HRESULT GetGlobalLocationPermission(BOOL* pfEnabled) mut => VT.[Friend]GetGlobalLocationPermission(&this, pfEnabled);

	public HRESULT CheckLocationCapability(uint32 dwClientThreadId) mut => VT.[Friend]CheckLocationCapability(&this, dwClientThreadId);
}

[CRepr]struct ISensorCollection : IUnknown
{
	public new const Guid IID = .(0x23571e11, 0xe545, 0x4dd8, 0xa3, 0x37, 0xb8, 0x9b, 0xf4, 0x4b, 0x10, 0xdf);
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid* sensorID) RemoveByID;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self) Clear;
	}


	public HRESULT GetAt(uint32 ulIndex, ISensor** ppSensor) mut => VT.[Friend]GetAt(&this, ulIndex, ppSensor);

	public HRESULT GetCount(uint32* pCount) mut => VT.[Friend]GetCount(&this, pCount);

	public HRESULT Add(ISensor* pSensor) mut => VT.[Friend]Add(&this, pSensor);
...
[CRepr]struct ISensor : IUnknown
{
	public new const Guid IID = .(0x5fa08f80, 0x2657, 0x458e, 0xaf, 0x75, 0x46, 0xf7, 0x3f, 0xa6, 0xac, 0x5c);

	public new VTable* VT { get => (.)mVT; }

	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid* pID) GetID;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid* pSensorCategory) GetCategory;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid* pSensorType) COM_GetType;
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, in Guid eventGuid, int16* pIsSupported) SupportsEvent;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid** ppValues, uint32* pCount) GetEventInterest;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid* pValues, uint32 count) SetEventInterest;
	...
	public HRESULT GetProperty(PROPERTYKEY* key, PROPVARIANT* pProperty) mut => VT.[Friend]GetProperty(&this, key, pProperty);

	public HRESULT GetProperties(IPortableDeviceKeyCollection* pKeys, IPortableDeviceValues** ppProperties) mut => VT.[Friend]GetProperties(&this, pKeys, ppProperties);

	public HRESULT GetSupportedDataFields(IPortableDeviceKeyCollection** ppDataFields) mut => VT.[Friend]GetSupportedDataFields(&this, ppDataFields);

	public HRESULT SetProperties(IPortableDeviceValues* pProperties, IPortableDeviceValues** ppResults) mut => VT.[Friend]SetProperties(&this, pProperties, ppResults);

	public HRESULT SupportsDataField(PROPERTYKEY* key, int16* pIsSupported) mut => VT.[Friend]SupportsDataField(&this, key, pIsSupported);

	public HRESULT GetState(SensorState* pState) mut => VT.[Friend]GetState(&this, pState);

	public HRESULT GetData(ISensorDataReport** ppDataReport) mut => VT.[Friend]GetData(&this, ppDataReport);

	public HRESULT SupportsEvent(in Guid eventGuid, int16* pIsSupported) mut => VT.[Friend]SupportsEvent(&this, eventGuid, pIsSupported);
...
[CRepr]struct ISensorDataReport : IUnknown
{
	public new const Guid IID = .(0x0ab9df9b, 0xc4b5, 0x4796, 0x88, 0x98, 0x04, 0x70, 0x70, 0x6a, 0x2e, 0x1d);
	...
	public HRESULT GetTimestamp(SYSTEMTIME* pTimeStamp) mut => VT.[Friend]GetTimestamp(&this, pTimeStamp);

	public HRESULT GetSensorValue(PROPERTYKEY* pKey, PROPVARIANT* pValue) mut => VT.[Friend]GetSensorValue(&this, pKey, pValue);

	public HRESULT GetSensorValues(IPortableDeviceKeyCollection* pKeys, IPortableDeviceValues** ppValues) mut => VT.[Friend]GetSensorValues(&this, pKeys, ppValues);
}

[CRepr]struct ISensorManagerEvents : IUnknown
{
	public new const Guid IID = .(0x9b3b0b86, 0x266a, 0x4aad, 0xb2, 0x1f, 0xfd, 0xe5, 0x50, 0x10, 0x01, 0xb7);
	...
	public HRESULT OnSensorEnter(ISensor* pSensor, SensorState state) mut => VT.[Friend]OnSensorEnter(&this, pSensor, state);
}

[CRepr]struct ISensorEvents : IUnknown
{
	public new const Guid IID = .(0x5d8dcc91, 0x4641, 0x47e7, 0xb7, 0xc3, 0xb7, 0x4f, 0x48, 0xa6, 0xc3, 0x91);
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, ISensor* pSensor, in Guid eventID, IPortableDeviceValues* pEventData) OnEvent;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid* ID) OnLeave;
	}


	public HRESULT OnStateChanged(ISensor* pSensor, SensorState state) mut => VT.[Friend]OnStateChanged(&this, pSensor, state);
	...
	public HRESULT OnEvent(ISensor* pSensor, in Guid eventID, IPortableDeviceValues* pEventData) mut => VT.[Friend]OnEvent(&this, pSensor, eventID, pEventData);

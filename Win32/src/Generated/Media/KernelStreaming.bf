...
#region COM Types
[CRepr]struct IKsControl : IUnknown
{
	public new const Guid IID = .(0x28f54685, 0x06fd, 0x11d2, 0xb2, 0x7a, 0x00, 0xa0, 0xc9, 0x22, 0x31, 0x96);
...
{
	public new const Guid IID = .(0x3cb4a69d, 0xbb6f, 0x4d2b, 0x95, 0xb7, 0x45, 0x2d, 0x2c, 0x15, 0x5d, 0xb5);
...
{
	public new const Guid IID = .(0x4509f757, 0x2d46, 0x4637, 0x8e, 0x62, 0xce, 0x7d, 0xb9, 0x44, 0xf5, 0x7b);
...
{
	public new const Guid IID = .(0x478f3a9b, 0xe0c9, 0x4827, 0x92, 0x28, 0x6f, 0x55, 0x05, 0xff, 0xe7, 0x6a);
...
{
	public new const Guid IID = .(0xd9bd72ed, 0x290f, 0x4581, 0x9f, 0xf3, 0x61, 0x02, 0x7a, 0x8f, 0xe5, 0x32);
...
{
	public new const Guid IID = .(0xc99af463, 0xd629, 0x4ec4, 0x8c, 0x00, 0xe5, 0x4d, 0x68, 0x15, 0x42, 0x48);

	public new VTable* VT { get => (.)mVT; }

	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(/*IKsJackContainerId*/SelfOuter* self, Guid pJackContainerId) GetJackContainerId;
	}
...
{
	public new const Guid IID = .(0x31efac30, 0x515c, 0x11d0, 0xa9, 0xaa, 0x00, 0xaa, 0x00, 0x61, 0xbe, 0x93);
...
{
	public new const Guid IID = .(0x7f40eac0, 0x3947, 0x11d2, 0x87, 0x4e, 0x00, 0xa0, 0xc9, 0x22, 0x31, 0x96);

	public new VTable* VT { get => (.)mVT; }

	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(/*IKsAggregateControl*/SelfOuter* self, Guid AggregateClass) KsAddAggregate;
		protected new function [CallingConvention(.Stdcall)] HRESULT(/*IKsAggregateControl*/SelfOuter* self, Guid AggregateClass) KsRemoveAggregate;
	}
...
{
	public new const Guid IID = .(0x28f54683, 0x06fd, 0x11d2, 0xb2, 0x7a, 0x00, 0xa0, 0xc9, 0x22, 0x31, 0x96);

...
[CRepr]struct IUnknown
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppvObject) QueryInterface;
...
[CRepr]struct AsyncIUnknown : IUnknown
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid) Begin_QueryInterface;
...
[CRepr]struct IClassFactory : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, void** ppvObject) CreateInstance;
...
[CRepr]struct IActivationFilter : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 dwActivationType, Guid rclsid, Guid pReplacementClsId) HandleActivation;
	}
...
[CRepr]struct IInternalUnknown : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppv) QueryInternalInterface;
	}
...
[CRepr]struct IRpcChannelBuffer : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, RPCOLEMESSAGE* pMessage, Guid riid) GetBuffer;
...
[CRepr]struct IRpcChannelBuffer3 : IRpcChannelBuffer2
{
	...
	[CRepr]public struct VTable : IRpcChannelBuffer2.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, RPCOLEMESSAGE* pMsg, Guid riid, void** pInterface) GetCallContext;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, RPCOLEMESSAGE* pMsg, uint32 pdwDestContext, void** ppvDestContext) GetDestCtxEx;
...
[CRepr]struct IRpcStubBuffer : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] IRpcStubBuffer*(SelfOuter* self, Guid riid) IsIIDSupported;
...
[CRepr]struct IPSFactoryBuffer : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, IRpcProxyBuffer** ppProxy, void** ppv) CreateProxy;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown* pUnkServer, IRpcStubBuffer** ppStub) CreateStub;
	}
...
[CRepr]struct IChannelHook : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] void(SelfOuter* self, Guid uExtent, Guid riid, uint32 pDataSize) ClientGetSize;
		protected new function [CallingConvention(.Stdcall)] void(SelfOuter* self, Guid uExtent, Guid riid, uint32 pDataSize, void* pDataBuffer) ClientFillBuffer;
		protected new function [CallingConvention(.Stdcall)] void(SelfOuter* self, Guid uExtent, Guid riid, uint32 cbDataSize, void* pDataBuffer, uint32 lDataRep, HRESULT hrFault) ClientNotify;
		protected new function [CallingConvention(.Stdcall)] void(SelfOuter* self, Guid uExtent, Guid riid, uint32 cbDataSize, void* pDataBuffer, uint32 lDataRep) ServerNotify;
		protected new function [CallingConvention(.Stdcall)] void(SelfOuter* self, Guid uExtent, Guid riid, HRESULT hrFault, uint32 pDataSize) ServerGetSize;
		protected new function [CallingConvention(.Stdcall)] void(SelfOuter* self, Guid uExtent, Guid riid, uint32 pDataSize, void* pDataBuffer, HRESULT hrFault) ServerFillBuffer;
	}
...
[CRepr]struct ISurrogate : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid Clsid) LoadDllServer;
...
[CRepr]struct IGlobalInterfaceTable : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnk, Guid riid, uint32 pdwCookie) RegisterInterfaceInGlobal;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 dwCookie) RevokeInterfaceFromGlobal;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 dwCookie, Guid riid, void** ppv) GetInterfaceFromGlobal;
	}
...
[CRepr]struct IAsyncManager : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** pInterface) GetCallContext;
...
[CRepr]struct ICallFactory : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown* pCtrlUnk, Guid riid2, IUnknown** ppv) CreateCall;
	}
...
[CRepr]struct IAddrExclusionControl : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppEnumerator) GetCurrentAddrExclusionList;
...
[CRepr]struct IComThreadingInfo : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rguid) SetCurrentLogicalThreadId;
	}
...
[CRepr]struct IMachineGlobalObjectTable : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid clsid, PWSTR identifier, IUnknown* object, MachineGlobalObjectTableRegistrationToken__** token) RegisterObject;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid clsid, PWSTR identifier, Guid riid, void** ppv) GetObject;
...
[CRepr]struct IMoniker : IPersistStream
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IBindCtx* pbc, IMoniker* pmkToLeft, Guid riidResult, void** ppvResult) BindToObject;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IBindCtx* pbc, IMoniker* pmkToLeft, Guid riid, void** ppvObj) BindToStorage;
...
[CRepr]struct IClassActivator : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rclsid, uint32 dwClassContext, uint32 locale, Guid riid, void** ppv) GetClassObject;
	}
...
[CRepr]struct IOplockStorage : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PWSTR pwcsName, uint32 grfMode, uint32 stgfmt, uint32 grfAttrs, Guid riid, void** ppstgOpen) CreateStorageEx;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PWSTR pwcsName, uint32 grfMode, uint32 stgfmt, uint32 grfAttrs, Guid riid, void** ppstgOpen) OpenStorageEx;
	}
...
[CRepr]struct IUrlMon : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rclsid, PWSTR pszTYPE, PWSTR pszExt, uint32 dwFileVersionMS, uint32 dwFileVersionLS, PWSTR pszCodeBase, IBindCtx* pbc, uint32 dwClassContext, Guid riid, uint32 flags) AsyncGetClassBits;
	}
...
[CRepr]struct ISurrogateService : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rguidProcessID, IProcessLock* pProcessLock, BOOL* pfApplicationAware) Init;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rguidApplID, ApplicationType appType) ApplicationLaunch;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rguidApplID) ApplicationFree;
...
[CRepr]struct IServiceProvider : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid guidService, Guid riid, void** ppvObject) QueryService;
	}
...
[CRepr]struct ICatRegister : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rclsid, uint32 cCategories, Guid* rgcatid) RegisterClassImplCategories;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rclsid, uint32 cCategories, Guid* rgcatid) UnRegisterClassImplCategories;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rclsid, uint32 cCategories, Guid* rgcatid) RegisterClassReqCategories;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rclsid, uint32 cCategories, Guid* rgcatid) UnRegisterClassReqCategories;
	}
...
[CRepr]struct ICatInformation : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rclsid, uint32 cImplemented, Guid* rgcatidImpl, uint32 cRequired, Guid* rgcatidReq) IsClassOfCategories;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rclsid, IEnumGUID** ppenumCatid) EnumImplCategoriesOfClass;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rclsid, IEnumGUID** ppenumCatid) EnumReqCategoriesOfClass;
	}
...
[CRepr]struct IContextCallback : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PFNCONTEXTCALL pfnCallback, ComCallData* pParam, Guid riid, int32 iMethod, IUnknown* pUnk) ContextCallback;
	}
...
[CRepr]struct IBindStatusCallback : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown* punk) OnObjectAvailable;
	}
...
[CRepr]struct IBindHost : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IMoniker* pMk, IBindCtx* pBC, IBindStatusCallback* pBSC, Guid riid, void** ppvObj) MonikerBindToStorage;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IMoniker* pMk, IBindCtx* pBC, IBindStatusCallback* pBSC, Guid riid, void** ppvObj) MonikerBindToObject;
	}
...
[CRepr]struct IDispatch : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, PWSTR* rgszNames, uint32 cNames, uint32 lcid, int32* rgDispId) GetIDsOfNames;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, int32 dispIdMember, Guid riid, uint32 lcid, uint16 wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, uint32 puArgErr) Invoke;
	}
...
[CRepr]struct ITypeInfo : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, void** ppvObj) CreateInstance;
...
[CRepr]struct ITypeInfo2 : ITypeInfo
{
	...
	[CRepr]public struct VTable : ITypeInfo.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid guid, VARIANT* pVarVal) GetCustData;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 index, Guid guid, VARIANT* pVarVal) GetFuncCustData;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 indexFunc, uint32 indexParam, Guid guid, VARIANT* pVarVal) GetParamCustData;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 index, Guid guid, VARIANT* pVarVal) GetVarCustData;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 index, Guid guid, VARIANT* pVarVal) GetImplTypeCustData;
...
[CRepr]struct ITypeLib : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid guid, ITypeInfo** ppTinfo) GetTypeInfoOfGuid;
...
[CRepr]struct ISupportErrorInfo : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid) InterfaceSupportsErrorInfo;
	}
...
[CRepr]struct IConnectionPointContainer : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IConnectionPoint** ppCP) FindConnectionPoint;
	}

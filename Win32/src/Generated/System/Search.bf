...
[CRepr]struct ICondition : IPersistStream
{
	...
	[CRepr]public struct VTable : IPersistStream.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppv) GetSubConditions;
...
[CRepr]struct IRowsetInfo : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint iOrdinal, Guid riid, IUnknown** ppReferencedRowset) GetReferencedRowset;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown** ppSpecification) GetSpecification;
	}
...
[CRepr]struct IRowPosition : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown** ppRowset) GetRowset;
...
[CRepr]struct IViewRowset : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown** ppObject) GetSpecification;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, IUnknown** ppRowset) OpenViewRowset;
	}
...
[CRepr]struct IViewChapter : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown** ppRowset) GetSpecification;
...
[CRepr]struct IRowsetView : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, IUnknown** ppView) CreateView;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint hChapter, Guid riid, uint phChapterSource, IUnknown** ppView) GetView;
	}
...
[CRepr]struct ICommand : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, DBPARAMS* pParams, int pcRowsAffected, IUnknown** ppRowset) Execute;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown** ppSession) GetDBSession;
	}
...
[CRepr]struct IMultipleResults : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, int lResultFlag, Guid riid, int pcRowsAffected, IUnknown** ppRowset) GetResult;
	}
...
[CRepr]struct ICommandText : ICommand
{
	...
	[CRepr]public struct VTable : ICommand.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid rguidDialect, PWSTR pwszCommand) SetCommandText;
	}
...
[CRepr]struct IColumnsRowset : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, uint cOptColumns, DBID* rgOptColumns, Guid riid, uint32 cPropertySets, DBPROPSET* rgPropertySets, IUnknown** ppColRowset) GetColumnsRowset;
	}
...
[CRepr]struct IDBCreateCommand : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, IUnknown** ppCommand) CreateCommand;
	}
...
[CRepr]struct IDBCreateSession : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, IUnknown** ppDBSession) CreateSession;
	}
...
[CRepr]struct ISourcesRowset : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, uint32 cPropertySets, DBPROPSET* rgProperties, IUnknown** ppSourcesRowset) GetSourcesRowset;
	}
...
[CRepr]struct IDBDataSourceAdmin : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 cPropertySets, DBPROPSET* rgPropertySets, IUnknown* pUnkOuter, Guid riid, IUnknown** ppDBSession) CreateDataSource;
...
[CRepr]struct ITableDefinition : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, DBID* pTableID, uint cColumnDescs, DBCOLUMNDESC* rgColumnDescs, Guid riid, uint32 cPropertySets, DBPROPSET* rgPropertySets, DBID** ppTableID, IUnknown** ppRowset) CreateTable;
...
[CRepr]struct IOpenRowset : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, DBID* pTableID, DBID* pIndexID, Guid riid, uint32 cPropertySets, DBPROPSET* rgPropertySets, IUnknown** ppRowset) OpenRowset;
	}
...
[CRepr]struct IDBSchemaRowset : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid rguidSchema, uint32 cRestrictions, VARIANT* rgRestrictions, Guid riid, uint32 cPropertySets, DBPROPSET* rgPropertySets, IUnknown** ppRowset) GetRowset;
...
[CRepr]struct IMDDataset : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, uint iAxis, Guid riid, uint32 cPropertySets, DBPROPSET* rgPropertySets, IUnknown** ppRowset) GetAxisRowset;
...
[CRepr]struct IMDRangeRowset : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, uint ulStartCell, uint ulEndCell, Guid riid, uint32 cPropertySets, DBPROPSET* rgPropertySets, IUnknown** ppRowset) GetRangeRowset;
	}
...
[CRepr]struct IParentRowset : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, uint iOrdinal, Guid riid, IUnknown** ppRowset) GetChildRowset;
	}
...
[CRepr]struct IErrorRecords : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 ulRecordNum, Guid riid, IUnknown** ppObject) GetCustomErrorObject;
...
[CRepr]struct IGetDataSource : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown** ppDataSource) GetDataSource;
	}
...
[CRepr]struct ITableDefinitionWithConstraints : ITableCreation
{
	...
	[CRepr]public struct VTable : ITableCreation.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, DBID* pTableID, uint cColumnDescs, DBCOLUMNDESC* rgColumnDescs, uint32 cConstraintDescs, DBCONSTRAINTDESC* rgConstraintDescs, Guid riid, uint32 cPropertySets, DBPROPSET* rgPropertySets, DBID** ppTableID, IUnknown** ppRowset) CreateTableWithConstraints;
...
[CRepr]struct IRow : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown** ppRowset, uint phRow) GetSourceRowset;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, DBID* pColumnID, Guid rguidColumnType, uint32 dwBindFlags, Guid riid, IUnknown** ppUnk) Open;
	}
...
[CRepr]struct IGetRow : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, uint hRow, Guid riid, IUnknown** ppUnk) GetRowFromHROW;
...
[CRepr]struct IBindResource : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, PWSTR pwszURL, uint32 dwBindURLFlags, Guid rguid, Guid riid, IAuthenticate* pAuthenticate, DBIMPLICITSESSION* pImplSession, uint32 pdwBindStatus, IUnknown** ppUnk) Bind;
	}
...
[CRepr]struct ICreateRow : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, PWSTR pwszURL, uint32 dwBindURLFlags, Guid rguid, Guid riid, IAuthenticate* pAuthenticate, DBIMPLICITSESSION* pImplSession, uint32 pdwBindStatus, PWSTR* ppwszNewURL, IUnknown** ppUnk) CreateRow;
	}
...
[CRepr]struct IGetSession : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown** ppSession) GetSession;
	}
...
[CRepr]struct IGetSourceRow : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, IUnknown** ppRow) GetSourceRow;
	}
...
[CRepr]struct ICommandStream : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, Guid rguidDialect, IUnknown* pCommandStream) SetCommandStream;
	}
...
[CRepr]struct IQuerySolution : IConditionFactory
{
	...
	[CRepr]public struct VTable : IConditionFactory.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppParseErrors) GetErrors;
...
[CRepr]struct IConditionFactory2 : IConditionFactory
{
	...
	[CRepr]public struct VTable : IConditionFactory.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, BOOL fVal, CONDITION_CREATION_OPTIONS cco, Guid riid, void** ppv) CreateTrueFalse;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, ICondition* pcSub, CONDITION_CREATION_OPTIONS cco, Guid riid, void** ppv) CreateNegation;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, CONDITION_TYPE ct, IObjectArray* poaSubs, CONDITION_CREATION_OPTIONS cco, Guid riid, void** ppv) CreateCompoundFromObjectArray;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, CONDITION_TYPE ct, ICondition** ppcondSubs, uint32 cSubs, CONDITION_CREATION_OPTIONS cco, Guid riid, void** ppv) CreateCompoundFromArray;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PROPERTYKEY* propkey, CONDITION_OPERATION cop, PWSTR pszValue, PWSTR pszLocaleName, CONDITION_CREATION_OPTIONS cco, Guid riid, void** ppv) CreateStringLeaf;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PROPERTYKEY* propkey, CONDITION_OPERATION cop, int32 lValue, CONDITION_CREATION_OPTIONS cco, Guid riid, void** ppv) CreateIntegerLeaf;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PROPERTYKEY* propkey, CONDITION_OPERATION cop, BOOL fValue, CONDITION_CREATION_OPTIONS cco, Guid riid, void** ppv) CreateBooleanLeaf;
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, ICondition* pc, STRUCTURED_QUERY_RESOLVE_OPTION sqro, SYSTEMTIME* pstReferenceTime, Guid riid, void** ppv) ResolveCondition;
	}
...
[CRepr]struct IEntity : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** pRelationships) Relationships;
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** pMetaData) MetaData;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** pNamedEntities) NamedEntities;
...
[CRepr]struct ISchemaProvider : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** pEntities) Entities;
...
[CRepr]struct IQueryParserManager : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, PWSTR pszCatalog, uint16 langidForKeywords, Guid riid, void** ppQueryParser) CreateLoadedParser;
...
[CRepr]struct ISearchNotifyInlineSite : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid guidCatalogResetSignature, Guid guidCheckPointSignature, uint32 dwLastCheckPointNumber) OnCatalogStatusChange;
	}
	...
	public HRESULT OnCatalogStatusChange(Guid guidCatalogResetSignature, Guid guidCheckPointSignature, uint32 dwLastCheckPointNumber) mut => VT.[Friend]OnCatalogStatusChange(&this, guidCatalogResetSignature, guidCheckPointSignature, dwLastCheckPointNumber);
}
...
[CRepr]struct ISearchCatalogManager : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, ISearchNotifyInlineSite* pISearchNotifyInlineSite, Guid riid, void** ppv, Guid pGUIDCatalogResetSignature, Guid pGUIDCheckPointSignature, uint32 pdwLastCheckPointNumber) GetItemsChangedSink;
...
[CRepr]struct ISearchLanguageSupport : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 lcid, Guid riid, void** ppWordBreaker, uint32 pLcidUsed) LoadWordBreaker;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint32 lcid, Guid riid, void** ppStemmer, uint32 pLcidUsed) LoadStemmer;
...
[CRepr]struct ISubscriptionMgr2 : ISubscriptionMgr
{
	...
	[CRepr]public struct VTable : ISubscriptionMgr.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid pSubscriptionCookie, ISubscriptionItem** ppSubscriptionItem) GetItemFromCookie;
...
[CRepr]struct DataSource : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, uint16 bstrDM, Guid riid, IUnknown** ppunk) getDataMember;
...
[CRepr]struct IDBPromptInitialize : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, HWND hWndParent, uint32 dwPromptOptions, uint32 cSourceTypeFilter, uint32* rgSourceTypeFilter, PWSTR pwszszzProviderFilter, Guid riid, IUnknown** ppDataSource) PromptDataSource;
...
[CRepr]struct IDataInitialize : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, uint32 dwClsCtx, PWSTR pwszInitializationString, Guid riid, IUnknown** ppDataSource) GetDataSource;
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid clsidProvider, IUnknown* pUnkOuter, uint32 dwClsCtx, PWSTR pwszReserved, Guid riid, IUnknown** ppDataSource) CreateDBInstance;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid clsidProvider, IUnknown* pUnkOuter, uint32 dwClsCtx, PWSTR pwszReserved, COSERVERINFO* pServerInfo, uint32 cmq, MULTI_QI* rgmqResults) CreateDBInstanceEx;
...
[CRepr]struct IRowsetNextRowset : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid riid, IUnknown** ppNextRowset) GetNextRowset;
	}
...
[CRepr]struct IDBSchemaCommand : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IUnknown* pUnkOuter, Guid rguidSchema, ICommand** ppCommand) GetCommand;

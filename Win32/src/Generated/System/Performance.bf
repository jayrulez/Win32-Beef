...
[CRepr]struct ITraceDataCollector : IDataCollector
{
	...
	[CRepr]public struct VTable : IDataCollector.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(/*ITraceDataCollector*/SelfOuter* self, Guid guid) get_Guid;
...
[CRepr]struct ITraceDataProvider : IDispatch
{
	...
	[CRepr]public struct VTable : IDispatch.VTable
	{
		...
		protected new function [CallingConvention(.Stdcall)] HRESULT(/*ITraceDataProvider*/SelfOuter* self, Guid guid) get_Guid;

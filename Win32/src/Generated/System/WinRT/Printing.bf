...
[CRepr]struct IPrinting3DManagerInterop : IInspectable
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, Guid riid, void** printManager) GetForWindow;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, Guid riid, void** asyncOperation) ShowPrintUIForWindowAsync;
	}

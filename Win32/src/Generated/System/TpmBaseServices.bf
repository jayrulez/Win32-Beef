...
public static
{
	[Import("tbs.lib"), CLink, CallingConvention(.Stdcall)]
	...
	[Import("tbs.lib"), CLink, CallingConvention(.Stdcall)]
	public static extern HRESULT GetDeviceIDString(char8* pszWindowsAIK, uint32 cchWindowsAIK, uint32* pcchResult, BOOL* pfProtectedByTPM);

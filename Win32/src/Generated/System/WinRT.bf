...
[CRepr]struct IAgileReference : IUnknown
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** ppvObjectReference) Resolve;
	}
...
[CRepr]struct ISpatialInteractionManagerInterop : IInspectable
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND window, Guid riid, void** spatialInteractionManager) GetForWindow;
	}
...
[CRepr]struct IHolographicSpaceInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND window, Guid riid, void** holographicSpace) CreateForWindow;
	}
...
[CRepr]struct IAccountsSettingsPaneInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, Guid riid, void** accountsSettingsPane) GetForWindow;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, Guid riid, void** asyncAction) ShowManageAccountsForWindowAsync;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, Guid riid, void** asyncAction) ShowAddAccountForWindowAsync;
	}
...
[CRepr]struct IAppServiceConnectionExtendedExecution : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** operation) OpenForExtendedExecutionAsync;
	}
...
[CRepr]struct IDragDropManagerInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND hwnd, Guid riid, void** ppv) GetForWindow;
	}
...
[CRepr]struct IInputPaneInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, Guid riid, void** inputPane) GetForWindow;
	}
...
[CRepr]struct IPlayToManagerInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, Guid riid, void** playToManager) GetForWindow;
...
[CRepr]struct IUserActivityInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND window, Guid iid, void** value) CreateSessionForWindow;
	}
...
[CRepr]struct IUserActivityRequestManagerInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND window, Guid iid, void** value) GetForWindow;
	}
...
[CRepr]struct IUserConsentVerifierInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, HSTRING message, Guid riid, void** asyncOperation) RequestVerificationForWindowAsync;
	}
...
[CRepr]struct IWebAuthenticationCoreManagerInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, IInspectable* request, Guid riid, void** asyncInfo) RequestTokenForWindowAsync;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, IInspectable* request, IInspectable* webAccount, Guid riid, void** asyncInfo) RequestTokenWithWebAccountForWindowAsync;
	}
...
[CRepr]struct IWeakReference : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void** objectReference) Resolve;
	}
...
[CRepr]struct ISystemMediaTransportControlsInterop : IInspectable
{
	...
	[CRepr]public struct VTable : IInspectable.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, Guid riid, void** mediaTransportControl) GetForWindow;
	}
...
[CRepr]struct IShareWindowCommandSourceInterop : IUnknown
{
	...
	[CRepr]public struct VTable : IUnknown.VTable
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, HWND appWindow, Guid riid, void** shareWindowCommandSource) GetForWindow;
	}

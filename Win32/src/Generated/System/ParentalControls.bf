...
#region COM Types
[CRepr]struct IWPCProviderState : IUnknown
{
	public new const Guid IID = .(0x50b6a267, 0xc4bd, 0x450b, 0xad, 0xb5, 0x75, 0x90, 0x73, 0x83, 0x7c, 0x9e);
...
[CRepr]struct IWPCProviderConfig : IUnknown
{
	public new const Guid IID = .(0xbef54196, 0x2d02, 0x4a26, 0xb6, 0xe5, 0xd6, 0x5a, 0xf2, 0x95, 0xd0, 0xf1);
	...
	public HRESULT RequestOverride(HWND hWnd, BSTR bstrPath, WPCFLAG_RESTRICTION dwFlags) mut => VT.[Friend]RequestOverride(&this, hWnd, bstrPath, dwFlags);
}

[CRepr]struct IWPCSettings : IUnknown
{
	public new const Guid IID = .(0x8fdf6ca1, 0x0189, 0x47e4, 0xb6, 0x70, 0x1a, 0x8a, 0x46, 0x36, 0xe3, 0x40);
...
{
	public new const Guid IID = .(0x95e87780, 0xe158, 0x489e, 0xb4, 0x52, 0xbb, 0xb8, 0x50, 0x79, 0x07, 0x15);
...
{
	public new const Guid IID = .(0xffccbdb8, 0x0992, 0x4c30, 0xb0, 0xf1, 0x1c, 0xbb, 0x09, 0xc2, 0x40, 0xaa);
...
{
	public new const Guid IID = .(0x4ff40a0f, 0x3f3b, 0x4d7c, 0xa4, 0x1b, 0x4f, 0x39, 0xd7, 0xb4, 0x4d, 0x05);
...
{
	public new const Guid IID = .(0x28b4d88b, 0xe072, 0x49e6, 0x80, 0x4d, 0x26, 0xed, 0xbe, 0x21, 0xa7, 0xb9);
...
{
	public new const Guid IID = .(0x41eba572, 0x23ed, 0x4779, 0xbe, 0xc1, 0x8d, 0xf9, 0x62, 0x06, 0xc4, 0x4c);

...
[CRepr]struct IMarshal : IUnknown
{
	...
	{
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void* pv, uint32 dwDestContext, void* pvDestContext, uint32 mshlflags, Guid pCid) GetUnmarshalClass;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, Guid riid, void* pv, uint32 dwDestContext, void* pvDestContext, uint32 mshlflags, uint32 pSize) GetMarshalSizeMax;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IStream* pStm, Guid riid, void* pv, uint32 dwDestContext, void* pvDestContext, uint32 mshlflags) MarshalInterface;
		protected new function [CallingConvention(.Stdcall)] HRESULT(SelfOuter* self, IStream* pStm, Guid riid, void** ppv) UnmarshalInterface;
